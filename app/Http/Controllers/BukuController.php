...
class BukuController extends Controller
{
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect('/kelola/petani/daftar')->with('status', 'Sukses Menambah Data Petani');
    }
    ...
    public function edit(Request $request)
    {
        ...
        return redirect('/kelola/petani/daftar')->with('status', 'Sukses Edit Data Petani');
    }
    ...
    public function delete($slug)
    {
        ...
        $buku->delete();
        return redirect('/kelola/petani/daftar')->with('status', 'Sukses Hapus Data Petani');
    }
}
