...
class PeminjamanController extends Controller
{
    ...
    public function tambah(Request $request)
    {
        ...
        return redirect('/kelola/penyewaan/daftar')->with('status', 'Sukses Menambah Data Peminjaman');
    }
    ...
    public function pengembalian(Request $request)
    {
        ...
        return redirect('/kelola/penyewaan/daftar')->with('status', 'Sukses Mengembalikan Petani');
    }

    public function delete($id)
    {
        Peminjaman::find($id)->delete();
        return redirect('/kelola/penyewaan/daftar')->with('status', 'Sukses Hapus Data Peminjaman');
    }
}
