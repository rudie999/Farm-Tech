...
Daftar Penyewaan Petani | Sistem Informasi Jasa Petani
...
<img id="loading-image" src="<?php echo e(asset('img/loader.gif')); ?>"
...
<div class="main-content-inner">
    <div class="row">
        <div class="col-lg-12 mt-5">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Daftar Penyewaan Jasa Petani</h4>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="badge badge-info btn-sm m-1" data-toggle="modal"
                                            ...
                                            onclick="detailPeminjaman('<?php echo e($peminjaman->id); ?>','<?php echo e($peminjaman->user->name); ?>')"><i
                                                class="fa fa-eye"></i>
                                            Detail</button>
                                        ...
                                        <button class="badge badge-success btn-sm m-1" data-toggle="modal"
                                            ...
                                            onclick="pengembalianPinjaman('<?php echo e($peminjaman->id); ?>','<?php echo e($hari_pengembalian); ?>','<?php echo e($peminjaman->user->name); ?>','<?php echo e(date('Y-m-d')); ?>')"><i
                                                class="fa fa-undo"></i>
                                            Penyewaan</button>
                                        <a onclick="return confirm('Apakah anda yakin ingin menghapus data penyewaan ini?')"
                                            href="/kelola/penyewaan/delete/<?php echo e($peminjaman->id); ?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Tambah Data Penyewaan Petani</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/kelola/penyewaan/tambah" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="form-group">
                        <label>Nama Petani</label><br>
                        <select class="select-two form-control" id="nama_buku" name="nama_buku" required
                            style="width:100%">
                            <option value="">Cari Petani</option>
                            ...
                            <option value="<?php echo e($buku['nama']); ?>"><?php echo e($buku['nama'] . " - " . $buku['pengarang']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select class="select-two form-control" id="id_user" name="id_user" required style="width:100%">
                            <option value="">Cari Data Penyewa</option>
                            <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($user['id']); ?>"><?php echo e($user['name'] . " - " . $user['email']); ?>
                    ...
                    <div class="form-group">
                        ...
                        <label>Tanggal Penyewaan : <b><?php echo e($today = date('d-m-Y')); ?></b></label>
                        <label>Maksimal Tanggal Pengembalian :
                            <b><?php echo e(date('d-m-y', strtotime("+7 day", strtotime($today)))); ?></b></label>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                <button type="submit" class="btn btn-success">Tambah Data Penyewaan</button>
                </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="detailModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Penyewaan</span>
                </h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">×</span></button>
            </div>
            <div class="modal-body">
                <label style="font-weight: bolder">Nama Penyewa : </label><span id="nama_peminjam_detail"></span><br>
                <label style="font-weight: bolder">Nama Petani : </label><span id="nama_buku_detail"></span><br>
                <label style="font-weight: bolder">Tanggal Sewa : </label><span id="tanggal_pinjam_detail"></span><br>
                ...
                <label style="font-weight: bolder">Status Penyewaan : </label><span
...
<div class="modal fade" id="pengembalianModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pengembalian Petani</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="/kelola/penyewaan/pengembalian" method="POST">
                    <?php echo csrf_field(); ?>
                    ...
                    <small>
                        <h6>*Aturan : <span style="color:red">Anggota Petani Harus membayar denda terlebih dahulu jika ingin
                                mengembalikan petani.</span></h6>
                    </small>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                <button onclick="return confirm('Lanjutkan Proses Pengembalian Penyewaan?')" type="submit"
                    class="btn btn-success">Pengembalian Penyewaan</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    ...
    function detailPeminjaman(id, nama_anggota) {
            ...
            $.ajax({
                type: `GET`,
                url: `/kelola/penyewaan/detail/${id}`,
                dataType: 'json',
                beforeSend: function() {
                    $("#loading-image").show();
                },
...
<?php echo $__env->make('templates.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Proyek 1 - UAS\Example\siperpus\resources\views/peminjaman/daftar-peminjaman.blade.php ENDPATH**/ ?>